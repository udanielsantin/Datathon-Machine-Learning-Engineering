...
Retorna para cada fase:
- `media_prevista`: média do score previsto
- `media_gap_idade`: média da defasagem idade-série
- `media_notas`: média das notas (português, inglês, matemática)
- `media_ieg`: média do Índice de Engajamento
...
- status de saude da API (`/health`)
- historico de retornos da API com tendencia temporal
- medias globais por fase
- detalhe de fases por requisicao recente
- alerta configuravel para media prevista elevada
- auto-refresh opcional para acompanhamento continuo
